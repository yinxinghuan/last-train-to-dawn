...
const cartridge: StoryCartridge = {
  ...
  initialFacts: {
    'north-witness-page': true,
    'south-witness-page': true,
    'west-witness-page': true,
    'ledger-access': false,
  },
  endingDirector: {
    startRequirements: [{ type: 'fact', id: 'witness-pages', equals: 4 }, { type: 'fact', id: 'ledger-access', equals: true }],
    capabilities: [
...
const parsed = parseStoryProtocol(`[fact: id="east-witness-page" value="true"]
