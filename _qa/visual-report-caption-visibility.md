...
- Game/build：《开往黎明的末班车》，本地候选构建。
- Review target：Civic 决策态中央情境字幕。
- Viewports：390×844、320×568，platform-layout；沿用 `_qa/ui/carriage-interior-v2/cinematic-entry-external-guest-390x844.png` 做 external-guest 扩展检查。
