...
function build(locale: Locale): StoryCartridge {
  ...
  return {
    ...
    copy: {
      ...
      subtitle: s('最后一列还能移动的车', 'The last train still moving'),
      promise: s('选路线、组队伍、修列车；每一站都有人值得带上。', 'Choose routes, build a crew, repair the train—every stop leaves someone worth carrying forward.'),
    ...
    opening: {
      ...
      choices: [
        ...
        { id: 'address-passengers', label: s('进入候车厅说明路线与上车规则', 'Set the route and boarding rules in the waiting hall') },
      ],
    },
    characters: [
